    ...
    public partial class ManyToManyRelationShip : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_productBillDetails", x => new { x.ProductId, x.BillInvoiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_productPurchaseDetails", x => new { x.ProductId, x.PurchaseInvoiceId });
                    table.ForeignKey(
